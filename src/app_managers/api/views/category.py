...
from app_managers.api.serializers.category import CategorySerializers
...
class CategoryRetrieveUpdateDestroyView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_object(self):
        ...
        if obj is None:
            raise exceptions.NotFound(BaseErrors._change_error_variable('object_not_found', object=_('Category')))
        return obj
